import 'package:movie_app/src/features/popular_people/domain/entities/person_details_entity.dart';
...
class PersonDetailsModel extends PersonDetails {
  ...
  factory PersonDetailsModel.fromMap(Map<String, dynamic> json) =>
      PersonDetailsModel(
        adult: json['adult'],
